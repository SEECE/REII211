...
(function () {
  ...
  var BUNDLES = {
    ...
    tests: ['core', 'sorting/tape.js', 'recursion/tree.js', 'recursion/layout.js',
      ...
      'graph/spanning.js', 'graph/marks.js', 'graph/levels.js', 'graph/backtrack.js', 'graph/draw.js', 'graph/matrix.js',
      ...
      'tests/kit.js', 'tests/sorting.js', 'tests/graph.js', 'tests/graph-marks.js',
      'tests/graph-levels.js', 'tests/graph-backtrack.js', 'tests/graph-matrix.js',
      'tests/heuristics.js',
