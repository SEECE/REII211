/* BFS against Dijkstra on real streets — the claim the Manhattan page is FOR.

   Split out of js/tests/osm.js at the 200-line ceiling. That file checks what comes off the
   map; this one checks what the two searches make of it, which is a different question and the
   one the page exists to ask. js/tests/city.js is untouched and checks the same pair on the
   synthetic grid, where the answer is exact. */
(function () {
  'use strict';

  window.Check.suite('applications — fewest blocks against shortest, on real streets', function () {
